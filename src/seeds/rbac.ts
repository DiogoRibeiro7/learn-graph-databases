/**
 * RBAC graph seeding utilities.
 *
 * This module creates a sample authorization graph with users, roles,
 * role inheritance, permissions, and resources.
 */
...
export async function seedRbac(driver: Driver): Promise<void> {
